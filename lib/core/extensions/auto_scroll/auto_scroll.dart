...
import 'package:collect/core/extensions/auto_scroll/utils.dart';
  ...
  Future _scrollToIndex(
    ...
    if (isIndexStateInLayoutRange(index)) {
      ...
      while (prevOffset != currentOffset &&
        ...
        final moveTarget = _forecastMoveUnit(
          index,
          nearest,
          usedSuggestedRowHeightIfAny,
        )!;
...
typedef TagHighlightBuilder =
    Widget Function(BuildContext context, Animation<double> highlight);
