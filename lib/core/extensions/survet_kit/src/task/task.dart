...
import 'package:collect/core/extensions/survet_kit/src/task/identifier/task_identifier.dart';
...
import 'package:collect/core/extensions/survet_kit/src/task/task_not_defined_exception.dart';
...
abstract class Task {
  ...
  Task({TaskIdentifier? id, this.steps = const [], this.initalStep}) {
    if (id == null) {
      id = TaskIdentifier();
      return;
    }
