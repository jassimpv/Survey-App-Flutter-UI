...
class LanguageController extends GetxController {
  late RxBool isEnglish;
  late RxBool inFlight;

  @override
  void onInit() {
    super.onInit();
    isEnglish = RxBool(Get.locale?.languageCode == 'en');
    inFlight = RxBool(false);
  }
...
class LanguageWidegt extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => Semantics(
        button: true,
        label: _controller.isEnglish.value
            ? 'Language: English'
            : 'Language: Arabic',
            ...
            child: Stack(
              ...
              children: <Widget>[
                ...
                AnimatedAlign(
                  duration: const Duration(milliseconds: 280),
                  curve: Curves.easeInOut,
                  alignment: _controller.isEnglish.value
                    ...
                    child: Center(
                      child: AnimatedSwitcher(
                        ...
                        child: Image.asset(
                          ...
                          key: ValueKey<bool>(_controller.isEnglish.value),
                          width: (height - 12),
                          height: (height - 12),
                          fit: BoxFit.cover,
                        ),
